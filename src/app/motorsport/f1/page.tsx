    ...
    return (
        <div className="min-h-screen bg-[#0f0f0f] text-white">
            ...
            <nav className="sticky top-0 z-40 bg-[#0f0f0f]/90 backdrop-blur-md border-b border-white/5">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-3">
                        ...
                        <button
                            className={`ml-auto shrink-0 flex items-center gap-2 px-4 py-1.5 text-xs font-black uppercase tracking-wider transition-all transform -skew-x-6 bg-white/10 text-white hover:bg-red-600`}
                        >
            ...
            <section className="relative overflow-hidden min-h-[85vh] flex items-end">
                ...
                {/* Background layers */}
                <div className="absolute inset-0 bg-gradient-to-br from-red-950/60 via-[#0f0f0f] to-[#0f0f0f]" />
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20 pt-16 w-full">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-red-400 text-xs font-black uppercase tracking-widest">Live Season</span>
                        </div>
                    </div>
                    ...
                    <p className="text-zinc-400 font-bold uppercase tracking-[0.3em] text-sm mb-10 max-w-lg">
                        The pinnacle of motorsport. 24 races. 20 drivers. One world champion.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        ...
                        <button className="flex items-center gap-3 px-8 py-4 font-black uppercase italic tracking-wider text-sm border border-white/20 text-white hover:border-red-500 hover:text-red-400 transition-all transform -skew-x-6">
                            <span className="transform skew-x-6 flex items-center gap-3">
            ...
            <section id="next-races" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="flex items-end justify-between mb-10">
                        <div>
                            <div className="bg-red-600 inline-block px-6 py-1.5 transform -skew-x-6 mb-3">
                        ...
                        <Link href="/motorsport/f1/calendar" className="hidden sm:flex items-center gap-2 text-zinc-500 text-xs font-bold uppercase tracking-widest hover:text-white hover:underline">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        {broadcasts.map((broadcast) => (
                            <Link href={`/motorsport/f1/${broadcast.slug}`}
                                key={broadcast.id}
                            ...
                            >
                                ...
                                <div className={`relative bg-zinc-950 border transform -skew-x-3 overflow-hidden border-zinc-800`}>
                                    ...
                                    <div className="transform skew-x-3 p-6">
                                        ...
                                        {/* Race name */}
                                        <h3 className={`font-black italic uppercase leading-tight mb-1`}>
                                            {broadcast.title}
                                        </h3>
                                        ...
                                        <div className="space-y-2 mb-6">
                                            ...
                                            <div className="flex items-center gap-2 text-zinc-400 text-xs font-bold">
                                                ...
                                                <span>{formatDate(broadcast.dateTime)}</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-zinc-400 text-xs font-bold">
                                                <Clock className="w-3.5 h-3.5 shrink-0 text-zinc-600" />
                                                <span>{formatTime(broadcast.dateTime)}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 pt-4 border-t border-zinc-800">
                                            <div>
                                                ...
                                                <p className="text-white font-black italic text-lg leading-none">200</p>
                                            </div>
                                            <div>
                                                <p className="text-zinc-600 text-[9px] font-black uppercase tracking-widest">Distance</p>
                                                <p className="text-white font-black italic text-lg leading-none">300 km</p>
                                            </div>
                                            <div className="ml-auto self-end">
                                                <button className={`px-4 py-2 text-xs font-black uppercase italic transition-all transform -skew-x-6 bg-zinc-800 text-white hover:bg-red-600`}>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {STANDINGS.map((driver) => (
                                    <div
                                        key={driver.pos}
                                        className="group relative flex items-center bg-zinc-900 border border-zinc-800 hover:border-red-600/50 transition-all overflow-hidden cursor-pointer"
                                    >
                                        {/* Position accent */}
                                        <div className={`w-1 self-stretch ${driver.pos === 1 ? "bg-red-600" : driver.pos === 2 ? "bg-zinc-400" : driver.pos === 3 ? "bg-amber-600" : "bg-zinc-700"}`} />
                                        ...
                                        <div className="flex items-center gap-4 px-5 py-4 flex-1">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-white font-black italic uppercase text-sm leading-none group-hover:text-red-400 transition-colors truncate">
                                                    {driver.driver}
                                                </p>
                                        ...
                                        <div className="px-4 w-16 text-right shrink-0">
                                            <p className={`font-black italic text-sm ${driver.gap === "—" ? "text-red-500" : "text-zinc-500"}`}>
                                                {driver.gap}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={stat.label} className="group relative">
                                <div className="absolute inset-0 bg-red-600 transform -skew-x-6 translate-x-1 translate-y-1 transition-transform group-hover:translate-x-2 group-hover:translate-y-2" />
                                <div className="relative bg-zinc-950 border border-zinc-800 p-6 transform -skew-x-6 hover:border-red-600/50 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {NEWS.map((item) => (
                            <div key={item.title} className="group relative cursor-pointer">
                                <div className="absolute inset-0 bg-red-600 transform -skew-x-3 translate-x-1 translate-y-1 transition-transform group-hover:translate-x-2 group-hover:translate-y-2" />
                                <div className="relative bg-zinc-950 border border-zinc-800 p-6 transform -skew-x-3 hover:border-red-600/40 transition-all">
                                    <div className="transform skew-x-3">
                                        <div className="flex items-center justify-between mb-3">
                                            ...
                                            {item.hot && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-red-500 text-[10px] font-black uppercase">Hot</span>
                                                </div>
                                            )}
                                        </div>
                                        <h3 className="text-white font-black italic uppercase text-lg leading-tight mb-2 group-hover:text-red-400 transition-colors">
                                            {item.title}
                                        </h3>
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
                                            ...
                                            <span className="text-red-500 text-xs font-black uppercase italic flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-zinc-950">
                ...
                <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-red-600 via-red-400 to-transparent" />
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-red-400 text-xs font-black uppercase tracking-[0.3em]">Never Miss a Race</span>
                            </div>
                        ...
                        <div className="flex flex-col gap-3 shrink-0">
                            <button
                                className={`group relative flex items-center gap-3 px-10 py-5 font-black uppercase italic tracking-wider text-base transition-all transform -skew-x-6 overflow-hidden bg-white text-black hover:bg-red-600 hover:text-white`}
                            >
                                <span className="transform skew-x-6 flex items-center gap-3">
                            ...
                            <button className="flex items-center justify-center gap-3 px-10 py-3 font-black uppercase italic tracking-wider text-sm border border-zinc-700 text-zinc-400 hover:border-red-600 hover:text-red-400 transition-all transform -skew-x-6">
                                <span className="transform skew-x-6 flex items-center gap-3">
