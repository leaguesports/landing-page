    ...
    return (
        <div className="min-h-screen bg-[#0c0f0c] text-white">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-3">
                        ...
                        <div className="flex items-center gap-2 mr-6 shrink-0">
                            <div className="bg-green-500 px-3 py-1 transform -skew-x-6">
                        ...
                        <button
                            className={`ml-auto shrink-0 flex items-center gap-2 px-4 py-1.5 text-xs font-black uppercase tracking-wider transition-all transform -skew-x-6 bg-white/10 text-white hover:bg-green-500`}
                        >
            ...
            <section className="relative overflow-hidden min-h-[85vh] flex items-end">
                ...
                {/* Background layers */}
                <div className="absolute inset-0 bg-linear-to-br from-green-950/60 via-[#0c0f0c] to-[#0f0f0f]" />
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    {[...Array(8)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute h-px bg-linear-to-r from-transparent via-green-500/30 to-transparent"
                            style={{
                                top: `${10 + i * 12}%`,
                                left: "-10%",
                                right: "-10%",
                ...
                {/* Glowing orb */}
                <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-green-500/10 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20 pt-32 w-full">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div className="bg-green-500 px-4 py-1.5 transform -skew-x-6">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-green-400 text-xs font-black uppercase tracking-widest">Live Season</span>
                        </div>
                    </div>
                    ...
                    <p className="text-zinc-400 font-bold uppercase tracking-[0.3em] text-sm mb-10 max-w-lg">
                        From Formula 1 to MotoGP and WRC, we&apos;ve got you covered.
                    </p>
            ...
            <section id="series" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
                        {[
                            { name: "Formula 1", description: "The highest level of motorsport", color: 'red', href: '/motorsport/f1' },
                            { name: "MotoGP", description: "The highest level of motorcycle racing", color: 'red', href: '/motorsport/motogp' },
                            { name: "WRC", description: "The highest level of rally racing", color: 'green', href: '/motorsport/wrc' },
                            { name: "GT3", description: "The highest level of GT3 racing", color: 'blue', href: '/motorsport/gt3' },
                        ].map((series) => (
                            <Link key={series.name} href={series.href} className="group relative cursor-pointer transition-all duration-300">
                                <div className={`absolute inset-0 transform -skew-x-3 translate-x-1.5 translate-y-1.5 transition-transform group-hover:translate-x-2.5 group-hover:translate-y-2.5 bg-${series.color}-600`} />
                                <div className={`relative bg-zinc-950 border transform -skew-x-3 overflow-hidden border-${series.color}-600/50`}>
                                    <div className="transform skew-x-3 p-6">
                                        <h3 className="font-black italic uppercase leading-tight mb-1 text-3xl text-white">{series.name}</h3>
                                        <p className="text-zinc-500 text-xs font-bold uppercase tracking-wider mb-5">{series.description}</p>
                                    </div>
                                </div>
                            </Link>
                        ))}
            ...
            <section id="next-races" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="flex items-end justify-between mb-10">
                        <div>
                            <div className="bg-green-500 inline-block px-6 py-1.5 transform -skew-x-6 mb-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        {NEXT_RACES.map((race) => (
                            ...
                            >
                                {/* Shadow offset */}
                                <div className={`absolute inset-0 transform -skew-x-3 translate-x-1.5 translate-y-1.5 transition-transform group-hover:translate-x-2.5 group-hover:translate-y-2.5 ${race.highlight ? "bg-green-600" : "bg-zinc-700"}`} />

                                <div className={`relative bg-zinc-950 border transform -skew-x-3 overflow-hidden ${race.highlight ? "border-green-600/50" : "border-zinc-800"}`}>

                                    {/* Top accent */}
                                    <div className={`h-1 w-full ${race.highlight ? "bg-green-600" : "bg-zinc-700"}`} />

                                    <div className="transform skew-x-3 p-6">

                                        {/* Round + flag */}
                                        <div className="flex items-center justify-between mb-4">
                                            <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${race.highlight ? "text-green-400" : "text-zinc-500"}`}>
                                                {race.round}
                                            </span>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {STANDINGS.map((driver) => (
                                    <div
                                        key={driver.pos}
                                        className="group relative flex items-center bg-zinc-900 border border-zinc-800 hover:border-green-600/50 transition-all overflow-hidden cursor-pointer"
                                    >
                                        {/* Position accent */}
                                        <div className={`w-1 self-stretch ${driver.pos === 1 ? "bg-green-600" : driver.pos === 2 ? "bg-zinc-400" : driver.pos === 3 ? "bg-amber-600" : "bg-zinc-700"}`} />
                                        ...
                                        <div className="flex items-center gap-4 px-5 py-4 flex-1">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-white font-black italic uppercase text-sm leading-none group-hover:text-green-400 transition-colors truncate">
                                                    {driver.driver}
                                                </p>
                                        ...
                                        <div className="px-4 w-16 text-right shrink-0">
                                            <p className={`font-black italic text-sm ${driver.gap === "—" ? "text-green-500" : "text-zinc-500"}`}>
                                                {driver.gap}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={stat.label} className="group relative">
                                <div className="absolute inset-0 bg-green-400 transform -skew-x-6 translate-x-1 translate-y-1 transition-transform group-hover:translate-x-2 group-hover:translate-y-2" />
                                <div className="relative bg-zinc-950 border border-zinc-800 p-6 transform -skew-x-6 hover:border-green-400/50 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {NEWS.map((item) => (
                            <div key={item.title} className="group relative cursor-pointer">
                                <div className="absolute inset-0 bg-green-600 transform -skew-x-3 translate-x-1 translate-y-1 transition-transform group-hover:translate-x-2 group-hover:translate-y-2" />
                                <div className="relative bg-zinc-950 border border-zinc-800 p-6 transform -skew-x-3 hover:border-green-600/40 transition-all">
                                    <div className="transform skew-x-3">
                                        <div className="flex items-center justify-between mb-3">
                                            ...
                                            {item.hot && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-green-500 text-[10px] font-black uppercase">Hot</span>
                                                </div>
                                            )}
                                        </div>
                                        <h3 className="text-white font-black italic uppercase text-lg leading-tight mb-2 group-hover:text-green-400 transition-colors">
                                            {item.title}
                                        </h3>
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
                                            ...
                                            <span className="text-green-500 text-xs font-black uppercase italic flex items-center gap-1 group-hover:gap-2 transition-all">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-green-400 text-xs font-black uppercase tracking-[0.3em]">Never Miss a Race</span>
                            </div>
                            <h2 className="text-4xl sm:text-5xl font-black italic uppercase leading-none tracking-tighter text-white mb-3">
                                Follow <span className="text-green-500">F2</span>
                            </h2>
