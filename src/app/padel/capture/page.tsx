...
import { PadelCaptureForm } from "@/components/padel/PadelCaptureForm";
...
export const metadata: Metadata = {
  title: "Capture Padel Result | LeagueSports",
  description: "Record a finished padel match without opening a live scorecard.",
...
export default async function CapturePadelMatchPage({
  searchParams,
}: {
