...
export const metadata: Metadata = {
  title: "Sign In",
  description:
    "Sign in to LeagueSports to manage your tournaments and leagues.",
};

export default function LoginPage() {
  return (
    <div className="relative min-h-screen flex items-center justify-center noise">
      {/* Background effects */}
      ...
      <div className="w-full max-w-md mx-4 animate-fade-in-up">
        <div className="glass-card rounded-3xl p-8 md:p-10 relative overflow-hidden">
          {/* Decorative gradient */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 bg-gradient-to-b from-primary/20 to-transparent blur-2xl" />
          ...
          <div className="relative z-10">
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary-light flex items-center justify-center">
                <span className="text-slate-950 font-bold text-xl">L</span>
              </div>
            </Link>
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full btn-primary py-4 rounded-xl text-base mt-2"
              >
                <span>Sign in</span>
              </button>
            </form>
