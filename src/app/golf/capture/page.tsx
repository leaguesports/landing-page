...
import { GolfCaptureForm } from "@/components/golf/GolfCaptureForm";
...
export const metadata: Metadata = {
  title: "Capture Golf Result | LeagueSports",
  description: "Record a finished golf round without opening a live scorecard.",
  robots: { index: false, follow: false },
};

export default async function CaptureGolfRoundPage({
  searchParams,
}: {
