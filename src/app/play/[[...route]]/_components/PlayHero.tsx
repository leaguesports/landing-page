...
export function PlayHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/5">
      <div className="absolute inset-0 bg-linear-to-br from-emerald-950/45 via-[#0c0f0c] to-[#0c0f0c]" />
      <div className="pointer-events-none absolute right-0 top-1/4 h-80 w-80 rounded-full bg-emerald-400/10 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <h1 className="font-display text-5xl tracking-wide text-white sm:text-6xl lg:text-7xl">
          {sportName}
          <span className="block text-emerald-400">{locationTitle}</span>
        </h1>

        <p className="mt-5 max-w-xl text-base leading-relaxed text-zinc-400">
          Showing {venueCount} venues where you can play.
        </p>

        <div className="mt-8 flex flex-wrap gap-8">
          {[
            { label: "Players nearby", value: "100+" },
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <button
            type="button"
            className="inline-flex min-h-11 items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-zinc-950 transition-colors hover:bg-emerald-400"
          >
