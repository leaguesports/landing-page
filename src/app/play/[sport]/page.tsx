...
const getMockData = (sportId: SportType) => {
  const data: Record<SportType, {
    primaryStat: { label: string; value: string; trend: string };
    stats: { label: string; value: string }[];
    recentSessions: { id: string; type: string; result: string; time: string; details: string }[];
    achievements: { id: string; name: string; description: string; earned: boolean; progress?: number }[];
    ...
    racing: {
      ...
      recentSessions: [
        { id: "1", type: "Race", result: "P1", time: "2h ago", details: "GT Championship - Spa" },
        { id: "2", type: "Practice", result: "Completed", time: "Yesterday", details: "Lap Consistency Drill" },
        { id: "3", type: "Race", result: "P3", time: "2 days ago", details: "Community Race - Monza" },
      ],
      achievements: [
        { id: "1", name: "Track Master", earned: true, description: "Complete 50 laps at any track" },
        { id: "2", name: "Speed Demon", earned: false, description: "Set a lap under 1:30", progress: 85 },
        { id: "3", name: "Clean Racer", earned: true, description: "Complete 10 races without incidents" },
      ],
    ...
    golf: {
      ...
      recentSessions: [
        { id: "1", type: "Round", result: "82", time: "Yesterday", details: "Pebble Beach - 18 holes" },
        { id: "2", type: "Practice", result: "Completed", time: "2 days ago", details: "Putting Green" },
        { id: "3", type: "Round", result: "78", time: "4 days ago", details: "St Andrews - 18 holes" },
      ],
      achievements: [
        { id: "1", name: "Eagle Eye", earned: true, description: "Make an eagle" },
        { id: "2", name: "Sub-80", earned: false, description: "Shoot under 80", progress: 92 },
        { id: "3", name: "Birdie Streak", earned: false, description: "3 birdies in a row", progress: 66 },
      ],
    ...
    padel: {
      ...
      recentSessions: [
        { id: "1", type: "Match", result: "Won", time: "3h ago", details: "vs Alex Thompson - 6-4, 6-3" },
        { id: "2", type: "Practice", result: "Completed", time: "Yesterday", details: "Bandeja Drills" },
        { id: "3", type: "Match", result: "Lost", time: "3 days ago", details: "vs Sarah Chen - 4-6, 3-6" },
      ],
      achievements: [
        { id: "1", name: "Hot Streak", earned: true, description: "Win 5 matches in a row" },
        { id: "2", name: "Century", earned: false, description: "Play 100 matches", progress: 45 },
        { id: "3", name: "Wall Master", earned: true, description: "Complete all wall drills" },
      ],
    ...
    darts: {
      ...
      recentSessions: [
        { id: "1", type: "Match", result: "Won", time: "5h ago", details: "vs Marcus - 3-1 (501)" },
        { id: "2", type: "Practice", result: "82.3 avg", time: "Yesterday", details: "Treble 20 Practice" },
        { id: "3", type: "Tournament", result: "2nd", time: "3 days ago", details: "Club Championship" },
      ],
      achievements: [
        { id: "1", name: "Maximum!", earned: true, description: "Hit a 180" },
        { id: "2", name: "Pro Average", earned: false, description: "Achieve 85+ average", progress: 92 },
        { id: "3", name: "Perfect Finish", earned: false, description: "170 checkout", progress: 0 },
      ],
    ...
    pool: {
      ...
      recentSessions: [
        { id: "1", type: "Match", result: "Won", time: "4h ago", details: "vs Jake - 5-3 (8-ball)" },
        { id: "2", type: "Practice", result: "Completed", time: "Yesterday", details: "Position Play" },
        { id: "3", type: "League", result: "Lost", time: "3 days ago", details: "League Match - 3-5" },
      ],
      achievements: [
        { id: "1", name: "Run Out", earned: true, description: "Clear the table from break" },
        { id: "2", name: "Consistent", earned: false, description: "Win 10 in a row", progress: 60 },
        { id: "3", name: "Safety First", earned: true, description: "Win with 5+ safeties" },
      ],
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        >
          ...
          <p className="text-xs text-slate-400">{drills.length} drills available</p>
        </Link>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 relative overflow-hidden">
            <div className={`absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl ${sport.gradient} opacity-10 blur-3xl`} />
            <div className="relative">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <p className="text-sm text-slate-400 mb-1">{data.primaryStat.label}</p>
                  <div className="flex items-baseline gap-3">
                    <span className="text-4xl font-bold text-white">{data.primaryStat.value}</span>
                    <span className="text-sm text-emerald-400 font-medium">{data.primaryStat.trend}</span>
                  </div>
                </div>
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${sport.gradient} flex items-center justify-center`}>
          ...
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-700/50 flex items-center justify-between">
              ...
              <Link href={`/play/${sportSlug}/history`} className="text-sm text-primary hover:text-primary-light">
                View all →
              </Link>
            </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-white">{session.result}</span>
                    </div>
                    <p className="text-sm text-slate-400 truncate">{session.details}</p>
                  </div>
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <p className="text-sm text-slate-400">
              {goalProgress >= 100
                ...
                : `${data.weeklyGoal.target - data.weeklyGoal.current} more to hit your goal`}
            </p>
          </div>
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-white">Try a Practice Drill</div>
                  <div className="text-xs text-white/60">Improve your {drills[0]?.name || "skills"}</div>
                </div>
              </div>
            </Link>
          </div>
