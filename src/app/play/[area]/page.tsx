                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        {NEXT_RACES.map((race) => (
                            ...
                            >
                                {/* Shadow offset */}
                                <div className={`absolute inset-0 transform -skew-x-3 translate-x-1.5 translate-y-1.5 transition-transform group-hover:translate-x-2.5 group-hover:translate-y-2.5 ${race.highlight ? "bg-red-600" : "bg-zinc-700"}`} />

                                <div className={`relative bg-zinc-950 border transform -skew-x-3 overflow-hidden ${race.highlight ? "border-red-600/50" : "border-zinc-800"}`}>

                                    {/* Top accent */}
                                    <div className={`h-1 w-full ${race.highlight ? "bg-red-600" : "bg-zinc-700"}`} />

                                    <div className="transform skew-x-3 p-6">

                                        {/* Round + flag */}
                                        <div className="flex items-center justify-between mb-4">
                                            <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${race.highlight ? "text-red-400" : "text-zinc-500"}`}>
                                                {race.round}
                                            </span>
