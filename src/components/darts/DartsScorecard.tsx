...
import { DartsLockedScorecard } from "@/components/darts/DartsLockedScorecard";
    ...
    <div className="flex min-h-dvh flex-col bg-[#0c0f0c] text-white">
      ...
      {locked ? (
        <div className="mx-auto flex w-full max-w-lg flex-1 flex-col px-4 py-5 sm:px-6">
          <DartsLockedScorecard match={match} />
          <div className="mt-auto space-y-3 pt-6 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
            <Link
              href="/darts/history"
        ...
        <>
          ...
          <ul className="mt-4 space-y-2 px-4">
            {match.players.map((player) => {
              const isSuggested = suggested === player.slot;
              return (
                <li
                  key={player.slot}
                  className={[
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-zinc-500">
                      {isSuggested ? "To throw" : `Slot ${player.slot}`}
                    </p>
                  </div>
