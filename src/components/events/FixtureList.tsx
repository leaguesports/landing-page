...
export function FixtureRow({
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col gap-3 border-t border-white/8 py-5 transition-colors first:border-t-0 first:pt-0 sm:flex-row sm:items-center sm:justify-between sm:gap-6"
    >
