...
function getApiProxySkipPattern(): string {
  ...
  // Ably live-scoring, fixture social feed/live board, cron ingest, and venue claim stay on Next.
  return "matches/.+/events(?:/|$)|realtime(?:/|$)|venues/claim(?:/|$)|fixtures/.+/(?:feed|live)(?:/|$)|cron(?:/|$)";
}
